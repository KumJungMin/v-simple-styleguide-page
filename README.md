...
- `packages/styleguide-viewer`
  - 스타일가이드 화면 UI입니다.
  - 문서 타입, 문서 정의 도우미, 정규화, iframe preview, renderer adapter를 함께 제공합니다.
...
4. `styleguide-viewer`의 renderer adapter가 iframe 안에 실제 컴포넌트를 mount 합니다.
